So far we have treated only two-party conversations, i.e.\ Alice and Bob 
...
everyone hears who said what and when.
Thus forcing Alice to say the same thing to all participants.
...
the messages in such a way that they yield the same message digest either.
